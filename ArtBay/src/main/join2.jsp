...
<form name='frm_join' method='post'>
	...
	<input type='text' name='pwd' placeholder="비밀번호" required="required">
	<input type='text' name='pwdCheck' placeholder="비밀번호 확인" required="required">
	<h5>주소</h5>
	<input type='text' name='zip' readonly placeholder="우편번호" required="required">
	<input type='button' value='우편번호' name='btnZip' required="required">
	<br/>
